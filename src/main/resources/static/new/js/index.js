    ...
    return new Promise(function (resolve, reject) {
        $.ajax({
            ...
            success: function (res) {
                ...
                var leftNav = '';
                for(var i=0,len=leftFloors.length;i<len;i++){
                    var mname=leftFloors[i].mname;
                    var centerLNum=leftFloors[i].centerLNum;
                    var exception = leftFloors[i].exception;
                    var diff = leftFloors[i].diff;
                ...
                for(var m=0,len=indexFloorList.length;m<len;m++){
                    var mname = indexFloorList[m].mname;
                    var exception = indexFloorList[m].exception;
                    var placeList = indexFloorList[m].placeList;
                    var on = indexFloorList[m].on;
                    ...
                    for(var n=0,len=placeList.length;n<len;n++){
                        var place = placeList[n].place;
                        var exception = placeList[n].exception;
                        var normal = 12 - parseInt(exception);
                        var diff = placeList[n].diff;
