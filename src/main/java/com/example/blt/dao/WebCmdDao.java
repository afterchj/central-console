...
public interface WebCmdDao {
    ...
    @Select("select mname from f_light_demo_intelligence d ,t_light_info i where d.lmac=i.lmac and i.y is null and i.status is null group by mname")
    ...
    @Select("select mname,Place,groupId from f_light_demo where other='intelligence' and mname='1楼' group by Place,groupId")
