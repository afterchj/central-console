...
@Service
@RocketMQMessageListener(topic = "blt_update_host_topic", consumerGroup = "blt_cloud_consumer_host_update_group")
public class HostUpdateConsumer implements RocketMQListener<String> {
